...
index=/crex/proj/snic2019-30-54/reference_guided/
...
do
    ...
    STAR --runThreadN 20 \
    --genomeDir $index \
    --readFilesIn /crex/proj/snic2019-30-54/transcriptome_populations/200117_A00605_0098_BHV2CFDSXX/${f}/*_R1_*_paired.fastq.gz /crex/proj/snic2019-30-54/transcriptome_populations/200117_A00605_0098_BHV2CFDSXX/${f}/*_R2_*_paired.fastq.gz \
    --twopassMode Basic	\
    --outSAMstrandField	intronMotif \
    --readFilesCommand zcat \
    --outSAMtype BAM Unsorted \
    --outFileNamePrefix $base"_INTRON_"
done
