...
#--sjdbFileChrStartEnd ${f}_SJ_out_filtered.tab
...
for f in $FILES;do
    ...
    STAR --runThreadN 20 \
    --genomeDir $index \
    --readFilesIn /crex/proj/naiss2023-23-494/patrik/transcriptome_populations/200117_A00605_0098_BHV2CFDSXX/${f}/*_R1_*_paired.fastq.gz /crex/proj/naiss2023-23-494/patrik/transcriptome_populations/200117_A00605_0098_BHV2CFDSXX/${f}/*_R2_*_paired.fastq.gz \
    --outSAMtype BAM SortedByCoordinate \
    --readFilesCommand zcat \
    --outFileNamePrefix $base"_2pass" \
